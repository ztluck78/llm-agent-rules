# GitHub Copilot: Evidence-First Analysis Rule
# Place at: .github/copilot-instructions.md (project-level)
...
# ============================================================================
# Installation notes for GitHub Copilot
# ============================================================================

- Project-level: copy to `.github/copilot-instructions.md` and commit
- Organization-level: configure via GitHub Copilot settings (admin required)
- Copilot Chat and Copilot Coding Agent both respect this file
