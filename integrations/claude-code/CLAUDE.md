# Claude Code: Evidence-First Analysis Rule
# Place this file at: ~/CLAUDE.md (user-level) or <project>/CLAUDE.md (project-level)
...
- User-level: copy this content to `~/CLAUDE.md` for global application
- Project-level: copy to `<project-root>/CLAUDE.md` for project-specific
- Claude Code auto-loads CLAUDE.md from these locations
- For team sharing, commit the project-level CLAUDE.md
